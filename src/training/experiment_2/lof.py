# lof.py define el algoritmo Local Outlier Factor (LOF),
...
def entrenar_lof(
    ...
    with mlflow.start_run(
        ...
        mlflow.log_param("algorithm", "LOF")
        ...
        # Crear el modelo con novelty=True para poder evaluar nuevos datos
        ...
        # LOF devuelve 1 = normal y -1 = anomalía
