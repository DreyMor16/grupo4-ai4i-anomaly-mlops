# one_class_svm.py define el algoritmo One-Class SVM,
...
def entrenar_one_class_svm(
    ...
    with mlflow.start_run(
        ...
        mlflow.log_param("algorithm", "One-Class SVM")
        ...
        # One-Class SVM devuelve 1 = normal y -1 = anomalía
