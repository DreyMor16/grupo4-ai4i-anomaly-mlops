...
def entrenar_ecod(
    ...
    with mlflow.start_run(
        ...
        # Obtener el anomaly score sobre los datos de validación
        anomaly_score = modelo.decision_function(
            X_val
        )

        # Obtener las predicciones: 0 = normal, 1 = anomalía
        ...
        configuracion = {
            "experiment": "02_algorithm_feature_set_comparison",
            "algorithm": "ECOD",
